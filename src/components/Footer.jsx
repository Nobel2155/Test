                    ...
                    <div className='lg:w-1/3 lg:pr-10'>
                        ...
                        <div className='w-[290px] mt-5'>
                            <p className='text-xs mb-1'>
                                Corporate Office: House # 12, Road # 12, Sector
                                # 04, Uttara, Dhaka 1230, Bangladesh.
                            </p>
                            <br />
                            <p className='text-xs'>
                                Commercial Address: KC Tower, 8th floor, Plot
                                13, Sonargaon Janapath road Sector 13. Uttara,
