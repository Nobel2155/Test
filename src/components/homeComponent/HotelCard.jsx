    ...
    <div className="bg-[#F5F5F5] p-5">
      <div className="max-w-[1200px] mx-auto mb-10">
        ...
        <div className="pt-5">
          ...
          >
              <SwiperSlide>
                <div data-aos="fade-up" className="w-[228px] h-[300px] group mx-auto bg-white shadow-md rounded-md overflow-hidden">
                  <Image
                    src={seePearl}
                    alt="Apartment"
                  ...
                  <div className="p-3">
                    <div>
                      ...
                      <div className="flex justify-between">
                        <p className="text-[#00703E] text-[10px]">BDT10,200 </p>
              ...
              <SwiperSlide>
                <div data-aos="fade-up" className="w-[228px] h-[300px] mx-auto group bg-white shadow-md rounded-md overflow-hidden">
                  <Image
                    src={burjAlArab}
                    alt="Apartment"
                  ...
                  <div className="p-3">
                    <div>
                      ...
                      <div className="flex justify-between">
                        <p className="text-[#00703E] text-[10px]">BDT 55,000</p>
                        <div className="flex gap-x-2">
                          <div className="border text-[#B0B0B0] border-[#B0B0B0] p-[1px]">
                            <a href="">
                              <PiShareFatThin />
                ...
                <div data-aos="fade-up" className="w-[228px] h-[300px] mx-auto group bg-white shadow-md rounded-md overflow-hidden">
                  ...
                  <div className="p-3">
                    <div>
                      ...
                      <div className="flex justify-between">
                        <p className="text-[#00703E] text-[10px]">BDT 25,000</p>
                        <div className="flex gap-x-2">
                          <div className="border text-[#B0B0B0] border-[#B0B0B0] p-[1px]">
                            <a href="">
                              <PiShareFatThin />
                      ...
                      <p className="text-[10px] text-[#7A7A7A]">
                      25Hours Heimat at Downtown Offers exquisite studios
                      </p>
                    </div>
                ...
                <div data-aos="fade-up" className="w-[228px] h-[300px] mx-auto group bg-white shadow-md rounded-md overflow-hidden">
                  ...
                  <div className="p-3">
                    <div>
                      ...
                      <div className="flex justify-between">
                        <p className="text-[#00703E] text-[10px]">BDT 48,000</p>
                        <div className="flex gap-x-2">
                          <div className="border text-[#B0B0B0] border-[#B0B0B0] p-[1px]">
                            <a href="">
                              <PiShareFatThin />
