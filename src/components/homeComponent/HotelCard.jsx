    ...
    <div className="bg-[#F5F5F5] p-5">
      <div className="max-w-[1200px] mx-auto mb-10">
        ...
        <div className="pt-5">
          ...
          >
              <SwiperSlide>
                <div className="w-[228px] h-[300px] group mx-auto bg-white shadow-md rounded-md overflow-hidden">
                  <Image
                    src={seePearl}
                    alt="Apartment"
              ...
              <SwiperSlide>
                <div className="w-[228px] h-[300px] mx-auto group bg-white shadow-md rounded-md overflow-hidden">
                  <Image
                    src={burjAlArab}
                    alt="Apartment"
