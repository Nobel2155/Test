                    ...
                    <div className='flex lg:flex-row md:flex-col-reverse flex-col-reverse lg:justify-between md:justify-between lg:gap-0 md:gap-20 gap-20 justify-center items-center'>
                        <div className='lg:w-[550px] p-4 text-center lg:text-start md:text-start'>
                            <h3 className='text-3xl text-[#282828] font-medium mb-2'>
                                Simplifies the process of experiencing the
                                world.
                            </h3>
                            <p className='text-xl text-[#282828] mb-4'>
                                HAMS Fly is a travel platform specializing in
                                finding the best airfare, hotel, and overall
                                travel deals.
                            </p>
                            <h3 className='text-3xl text-[#282828] font-medium mb-2'></h3>
                            <p className='text-xl text-[#282828] mb-4'>
                                Affordable Prices: Enjoy significant savings
                                compared to other travelwebsites.
                            </p>
                            <h3 className='text-3xl font-medium mb-2'></h3>
                            <p className='text-xl text-[#282828] mb-4'>
                                Sustainability Commitment:Eco-friendly and
                                community-focused travel solutions. Customer
                                Satisfaction:Read testimonials from our happy
                                clients.
                            </p>
