        ...
        <div className='max-w-[1200px] mx-auto'>
            <div className='text-start mb-1 lg:pl-5'>
                ...
                <div className='pt-1'>
                    <p className='text-xl lg:text-start md:text-center text-center lg:px-0 md:px-4 px-4'>
                        Save your money and get the Best & Cheap Airfare deals
                        in ticket than other airlines.
                    </p>
                </div>
            </div>
            ...
            >
                <SwiperSlide>
                    <div
                        data-aos='fade-up'
                        className='w-[242px] mx-auto group bg-white shadow-md overflow-hidden rounded-md'
                    >
                        <div>
                            <Image
                                src={picture1}
