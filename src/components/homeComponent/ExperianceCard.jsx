  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      ...
      <div>
        ...
        >
          <SwiperSlide>
            <div data-aos="fade-up" className="w-full max-w-[228px] h-[300px] overflow-hidden rounded-md shadow-md mx-auto group">
              <Image
                src={nafakhum}
                alt=""
          ...
          <SwiperSlide>
            <div data-aos="fade-up" className="w-full max-w-[228px] h-[300px] overflow-hidden group rounded-md shadow-md mx-auto">
              <Image
                src={sundorbon}
                alt=""
          ...
          <SwiperSlide>
            <div data-aos="fade-up" className="w-full max-w-[228px] h-[300px] group overflow-hidden rounded-md shadow-md mx-auto">
              <Image
                src={saintmartin}
                alt=""
          ...
          <SwiperSlide>
            <div data-aos="fade-up" className="w-full max-w-[228px] h-[300px] group rounded-md overflow-hidden shadow-md mx-auto">
              <Image
                src={amazon}
                alt=""
                className="object-cover object-center group-hover:scale-105 duration-500 w-full rounded-t-md h-[130px]"
