    ...
    const handleBookNow = async (e) => {
        ...
        try {
            const response = await fetch(
                "https://hamsfly-server-v1-0-0.onrender.com/api/users",
                requestOptions
            );
            if (!response.ok) {
                ...
                <div className='py-[30px] w-[660px]'>
                    ...
                    <div className='pt-5 flex flex-wrap gap-5'>
                        <div className='text-base flex flex-col gap-2 w-full sm:w-[260px]'>
                            ...
                            <input
                                className={`py-3 px-[14px] w-full rounded border border-gray-300 focus:outline-none focus:ring-blue-500 focus:ring-1 ${
                                    formErrors.givenName && "focus:ring-red-500"
                                }`}
                                type='text'
                                placeholder='Ex: John'
                                onChange={handleChange}
                        ...
                        <div className='text-base flex flex-col gap-2  w-full sm:w-[260px]'>
                            ...
                            <input
                                className={`py-3 px-[14px] w-full rounded border border-gray-300 focus:outline-none focus:ring-blue-500 focus:ring-1 ${
                                    formErrors.surName && "focus:ring-red-500"
                                }`}
                                type='text'
                        ...
                        <div className='text-base flex flex-col gap-2  w-full sm:w-[260px]'>
                            ...
                            <input
                                className={`py-3 px-[14px] w-full rounded border border-gray-300 focus:outline-none focus:ring-blue-500 focus:ring-1 ${
                                    formErrors.DOB && "focus:ring-red-500"
                                }`}
                                type='date'
                        ...
                        <div className='text-base flex flex-col gap-2  w-full sm:w-[260px]'>
                            ...
                            <input
                                className={`py-3 px-[14px] w-full rounded border border-gray-300 focus:outline-none focus:ring-blue-500 focus:ring-1 ${
                                    formErrors.email && "focus:ring-red-500"
                                }`}
                                type='email'
                        ...
                        <div className='text-base flex flex-col gap-2  w-full sm:w-[260px]'>
                            ...
                            <input
                                className={`py-3 px-[14px] w-full rounded border border-gray-300 focus:outline-none focus:ring-blue-500 focus:ring-1 ${
                                    formErrors.phone && "focus:ring-red-500"
                                }`}
                                type='number'
                ...
                <div className='max-w-[660px] flex flex-col gap-4 lg:gap-[30px]'>
                    ...
                    <div className='flex gap-5 flex-col'>
                        ...
                        <Paragraph width='full'>
                            Each passenger is allowed one free carry-on bag and
                            one personal item. First checked bag for each
                            passenger is also free.Second bag check fees are
                            waived for loyalty program members.See the{" "}
                            <a
                                className='text-[#039BE6] cursor-pointer'
                                href='#'
                            >
                                full bag policy.
                            </a>
                        ...
                        <div className='text-base font-normal flex gap-9'>
                            <button
                                ...
                                className='py-2 px-7 border rounded text-white bg-[#00703E] hover:bg-green-900 duration-300 transition'
                            >
                                Buy Now
                            </button>
                            <button
