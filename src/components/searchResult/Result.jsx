...
const getLocalStorageData = () => {
    return {
        departureDates:
            JSON.parse(localStorage.getItem("departureDates")) || [],
        departureAirports:
            JSON.parse(localStorage.getItem("departureAirports")) || [],
        arrivalAirports:
            JSON.parse(localStorage.getItem("arrivalAirports")) || [],
        ...
        return group.itineraries.map((itinerary) => {
            const legs = itinerary.legs.map((leg, index) => {
                ...
                for (let i = 0; i < schedules.length - 1; i++) {
                    ...
                    if (
                        currentSchedule.arrival.airport ===
                        nextSchedule.departure.airport
                    ) {
                        ...
                        const layoverTime =
                            Math.abs(departureTime - arrivalTime) / 60000;
                        transits.push({
                    ...
                    return (
                        ...
                        pricingInfo.fare.passengerInfoList.reduce(
                            (passengerSum, passengerInfo) => {
                                return (
                                    passengerSum +
                                    passengerInfo.passengerInfo.passengerNumber
                                );
                            },
                            0
                        )
    ...
    const fetchItineraryData = async (
        ...
        const requestOptions = {
            ...
            headers: {
                ...
                Authorization:
                    "Bearer **",
                Cookie: "incap_ses_1787_2768614=0SjoZhqWLgdPMbDpIbPMGPJAomYAAAAApLohNoE3k6viHlK62M2bnA==; nlbi_2768614=ZKBcKV/r9XrbAKhrRh9LCAAAAACFsRG/G1bTU1Ur3t/q4bKx; visid_incap_2768614=SPMPSIHqQUSMgkgbdUhsdjadOGYAAAAAQkIPAAAAAAA0To3MKwPR8OocZaNNanzT",
            },
            body: JSON.stringify({
                OTA_AirLowFareSearchRQ: {
                    Version: "5",
    ...
    useEffect(() => {
        ...
        const fetchAirlines = async () => {
            ...
            try {
                ...
                setAirlines(
                    data.carrierLogo.map(({ code, logo, name }) => ({
                        code,
                        logo,
                        name,
                    }))
                                                ...
                                                <div className='flex items-center justify-between w-full'>
                                                    <div className='flex flex-col items-center'>
                                                        <span className='font-semibold'>
                                                            {schedule.departure.time.substring(
                                                                0,
                                                                5
                                                            )}
                                                        </span>
                                                    ...
                                                    <div className='flex flex-col items-center'>
                                                        <span className='font-semibold'>
                                                            {schedule.arrival.time.substring(
                                                                0,
                                                                5
                                                            )}
                                                        </span>
                        ...
                        <div className='p-6 relative flex justify-center items-center flex-col text-center bg-[#133758a6] text-white'>
                            <div>
                                <p className='text-2xl font-bold'>
                                    Price:{" "}
                                    {
                                        selectedItinerary.pricingInformation[0]
                            ...
                            <button className='mt-4 bg-[#00703E] text-white py-3 px-6 rounded-lg hover:bg-green-700 font-bold transition-colors duration-300 absolute right-7'>
                                <Link href='/pages/bookFlights'>Book Now</Link>
                            </button>
                        </div>
                    </div>
                        ...
                        <div className=' w-[80%]'>
                            {itinerary.legs.map((leg, legIndex) => (
                                ...
                                >
                                    ...
                                    <div className='mr-1'>
                                        <div>
                                            {leg.schedules[0].departure.time.substring(
                                                0,
                                                5
                                            )}
                                        </div>
                                                ...
                                                (transit, idx) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className='relative'>
                                                            <div className='w-3 h-3 bg-gray-400 rounded-full flight-stop mx-1'></div>
                                                            <div className='absolute bottom-[7px] -left-[10px] hidden show'>
                                                                {transit.departureTime.substring(
                                                                    0,
                                                                    5
                                                                )}
                                                            </div>
                        ...
                        <div className='w-[20%] flex items-center justify-center text-center'>
                            <div>
                                <p className='text-black bold'>
                                    BDT{" "}
                                    {
                                        itinerary.pricingInformation[0].fare
